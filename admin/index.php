...
<html lang="en">
  ...
  <head>
    ...
    <title>Loja Virtual da ETEC</title>
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <div class="app-wrapper">
            ...
            >
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="?pg=Categorias" class="nav-link">
      ...
      <footer class="app-footer">
        ...
        <strong>
          Copyright &copy; 2025&nbsp;
          <a href="https://etecbebedouro.com.br" class="text-decoration-none">Etec prof. Idio Zucchi</a>.
        </strong>
